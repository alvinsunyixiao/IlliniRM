...
def digit_recognition(padded_num):
    ...
    segments = [
        ((u_x + bias, u_y + bias), (u_x + tube_width, u_y + height // 2)),	# top-left
        ((u_x + bias, u_y + height // 2 + bias), (u_x + tube_width, u_y + height - tube_width)),	# bottom-left
        ((u_x + width - tube_width, u_y), (u_x + width, u_y + height // 2)),	# top-right
        ((u_x + width - tube_width, u_y + height // 2 + bias), (u_x + width, u_y + height - tube_width)),	# bottom-right
